...
Sometimes working with knitr in RStudio projects get weird because of working directories
...
1. Use R
2. Make a project
3. Organize the project into folders
4. Break up scripts into smaller pieces
5. Use `here::here()` in knitr documents
